                    ...
                    <View style={styles.RighttalkBubbleSquare} >
                        ...
                        <View style={{ flexDirection: 'row', }}>
                            <View style={{ flex: 1, fontSize: widthScale(12), fontFamily: 'silka-medium-webfont', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <Text style={{ fontSize: widthScale(12), fontFamily: 'silka-regular-webfont', color: '#b2b2b2', marginLeft: '5%' }}>{item.msgdate}</Text>
                            </View>
            ...
            <View style={styles.maincontainer}>
                ...
                <ImageBackground style={CssStyles.backgroundImage}
                    ...
                    <ScrollView style={{ flex: 1, }}>
                                ...
                                <View style={[styles.talkBubbleSquare, { marginRight: '2%' }]} >
                                    ...
                                    <View style={{ flexDirection: 'row', }}>
                                        <View style={{ flex: 1, marginBottom: '2%' }}>
                                            <Text style={{ fontSize: RFValue(16, 812), fontFamily: 'silka-regular-webfont', color: '#b2b2b2', marginLeft: '6%', marginTop: '2%' }}>3.32pm</Text>
                                        </View>
                                    </View>
                                </View>
                        ...
                        <View style={{ alignItems: 'flex-end', margin: '1%', flexDirection: 'row' ,width:'80%',marginLeft:'auto', }}>
                            <View style={styles.RighttalkBubble}>
                                <View style={styles.RighttalkBubbleSquare} >
                                    <View style={{ marginLeft: "2%" }}>
                                        <Text style={{ flex: 3, fontSize: widthScale(12), fontFamily: 'silka-regular-webfont', margin: '3%' }}>
                        ...
                        <View style={{ flex: 1, alignItems: 'flex-start', margin: '1%', flexDirection: 'row' }}>
                            <View style={styles.talkBubble}>
                                ...
                                <View style={styles.talkBubbleSquare} >
                                    <View style={{ marginLeft: "2%" }}>
                                        <Text style={{ fontSize: widthScale(12), fontFamily: 'silka-bold-webfont', color: '#a0522d', margin: '3%', marginBottom: '1%', marginLeft: '4%' }}>
                                            Contactname
                                            </Text>
                                        <Text style={{ flex: 3, fontSize: widthScale(12), fontFamily: 'silka-regular-webfont', marginLeft: '4%', }}>
                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                            ...
                            >
                                ...
                                >
                                    <View style={{
                                        ...
                                        borderRadius: 20, position: 'absolute', marginLeft: '5%', marginRight: '5%', width: '90%', bottom: hp('9%', 812)
                                    }}>
                                        <ScrollView >
                                            <View style={{ margin: '1%', }}>
